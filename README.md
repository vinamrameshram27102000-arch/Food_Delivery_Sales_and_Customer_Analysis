# Food_Delivery_Sales_and_Customer_Analysis
...
* *Key Performance Indicators (KPIs):*
    * *Total Orders:* 2,746
    * *Delivered Orders:* 2,588
    * *Cancelled Orders:* 158
    * *Delivery Rate:* 94.2%
    * *Total Quantity Sold:* 15K
* *Sales Trends:* A line chart showing the fluctuation of orders throughout the month, identifying peak ordering days.
* *Customer Preferences:*
    * *Payment Methods:* Breakdown of UPI (62.6%), COD (27.31%), and Card (10.09%) usage.
    * *Food Type Distribution:* Analysis showing 'Main Course' as the most popular category (45.83%), followed by 'Snacks' (29.56%).
